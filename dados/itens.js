...
module.exports = {
  "florin de ouro": { itemNome: "Florin de Ouro", tipo: "Moeda", descricao: "A moeda comum de todos os reinos.", usavel: false, equipavel: false },
    ...
    "poção de cura menor": { nome: "Poção de Cura Menor", itemNome: "Poção de Cura Menor", tipo: "Consumível", descricao: "Restaura uma pequena quantidade de PV.", usavel: true, efeito: { tipoEfeito: "CURA_HP", valor: 25, mensagemAoUsar: "Você bebe a Poção de Cura Menor e sente um alívio imediato." }, cooldownSegundos: 60 },
