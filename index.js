        ...
        try {
            ...
            if (resultadoAcaoJogador.erro) {
                ...
                if (resultadoAcaoJogador.combateTerminou) {
                     await interaction.reply({ content: `Combate encerrado devido a um erro: ${resultadoAcaoJogador.erro}`, embeds: [], components: [] });
                }
                return;
            }
...
// --- END: Checagem de jogador responsável pelo combate ---
        ...
        // Repita TODO O MESMO FLUXO de atualização do embed igual ao do bloco de cima (pode copiar/colar o fluxo do "só tem um feitiço")
        if (!resultado || typeof resultado !== 'object') {
